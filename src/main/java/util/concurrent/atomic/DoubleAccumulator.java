 ...
 * contention among threads.  The function is applied with an existing
 * value (or identity) as one argument, and a given update as the
 * other argument. For example, to maintain a running maximum value,
 * you could supply {@code Double::max} along with {@code
